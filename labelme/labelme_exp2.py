...
from generate.generate_data import generating_fixed_task, generating_fixed_annotator
from lab import LAB
...
if __name__ == '__main__':
    ...
    #         exist_annotator = sampling(crowd_file, number).run_fixed_annotator()
    #         for generate_method_name in generate_methods:  # 一个样本文件在 每个生成方法下生成数据
    #             for j in range(max_generate_sum):
    #                 generate_file = main_dir + '/labelme_2/' + str(number) + '/' + generate_method_name + '/' + str(i) + '_' + str(j) + '.txt'
    #                 if generate_method_name == 'Mymodel_generate':
    #                     generating_fixed_annotator(crowd_file, truth_file, exist_annotator, generate_method_name, generate_file, train_loader)  # 生成20个数据集
    #                 else:
    #                     pool.apply_async(generating_fixed_annotator,
    #                                      args=(crowd_file, truth_file, exist_annotator, generate_method_name, generate_file, train_loader))
    #
    # pool.close()
    # pool.join()
    ...
    #
    #     mean_KL_list = []
    #     mean_KL_path = main_dir + '/labelme_2/KL/KL_mean_' + str(z) + '.csv'
    #     std_KL_list = []
    #     std_KL_path = main_dir + '/labelme_2/KL/KL_std_' + str(z) + '.csv'
    #
    #     mean_KS_stat_list = []
    #     mean_KS_stat_path = main_dir + '/labelme_2/KS/KS_stat_mean_' + str(z) + '.csv'
    #     std_KS_stat_list = []
    #     std_KS_stat_path = main_dir + '/labelme_2/KS/KS_stat_std_' + str(z) + '.csv'
    #
    #     mean_KS_pval_list = []
    #     mean_KS_pval_path = main_dir + '/labelme_2/KS/KS_pavl_mean_' + str(z) + '.csv'
    #     std_KS_pval_list = []
    #     std_KS_pval_path = main_dir + '/labelme_2/KS/KS_pavl_std_' + str(z) + '.csv'
    #
    ...
    #
    #             KL_list = []
    #             KL_path = main_dir + '/labelme_2/' + str(number) + '/' + generate_method_name + '/KL_total_' + str(
    #                 z) + '.csv'
    #
    #             KS_stat_list = []
    #             KS_stat_path = main_dir + '/labelme_2/' + str(
    #                 number) + '/' + generate_method_name + '/KS_stat_total_' + str(z) + '.csv'
    #             KS_pval_list = []
    #             KS_pval_path = main_dir + '/labelme_2/' + str(
    #                 number) + '/' + generate_method_name + '/KS_pval_total_' + str(z) + '.csv'
    #             for i in range(max_sampling_time):
    #                 for j in range(max_generate_sum):
    #                     generate_file = main_dir + '/labelme_2/' + str(number) + '/' + generate_method_name + '/' + str(
    #                         i) + '_' + str(j) + '.txt'
    ...
    #     # 生成数据汇聚
    #     for generate_method_name in generate_methods:   # 生成方法 5
    #         acc_path = main_dir + '/labelme_2/' + str(number) + '/' + generate_method_name + '/accuracy.csv'
    ...
    for number in data_scale_range:   # 汇聚排序
        ...
        mean_total_path = main_dir + '/labelme_2/' + str(number) + '/mean.csv'
        mean_total_list = []

        std_total_path = main_dir + '/labelme_2/' + str(number) + '/std.csv'
        std_total_list = []
        ...
        for generate_method_name in generate_methods:  # 生成方法 5
            generate_acc_path = main_dir + '/labelme_2/' + str(number) + '/' + generate_method_name + '/accuracy.csv'
