...
from utils import pre_deal, calculate_kl_ks

if __name__ == '__main__':
    main_dir = r'./datasets'
    crowd_file = main_dir + '/test_data/labelme_crowd_test.txt'
    truth_file = main_dir + '/test_data/labelme_truth_test.txt'
    ...
    data_scale_range = range(1000, 8000, 1000)
    max_sampling_time = 5
    max_generate_sum = 5
    pool = Pool()
    ...
    # train_data = LAB(
    #     data_dir=main_dir,
    #     crowd_dir='/test_data/labelme_crowd_test.txt'
    # )
    #
    ...
    #         sample_file = main_dir + '/labelme_3/' + str(number) + '/sampling/sampling_' + str(i) + '.txt'
    ...
    #                 generate_file = main_dir + '/labelme_3/' + str(number) + '/' + generate_method_name + '/' + str(i) + '_' + str(j) + '.txt'
    #                 if generate_method_name == 'Mymodel_generate':
    #                     generating(crowd_file, truth_file, sample_file, generate_method_name, generate_file, train_loader)  # 生成20个数据集
    #                 else:
    #                     pool.apply_async(generating,
    #                                      args=(crowd_file, truth_file, sample_file, generate_method_name, generate_file, train_loader))
    #
    # pool.close()
    # pool.join()
    ...
    # for z in range(8):
    #     mean_KL_list = []
    #     mean_KL_path = main_dir + '/labelme_3/KL/KL_mean_' + str(z) + '.csv'
    #     std_KL_list = []
    #     std_KL_path = main_dir + '/labelme_3/KL/KL_std_' + str(z) + '.csv'
    #
    #     mean_KS_stat_list = []
    #     mean_KS_stat_path = main_dir + '/labelme_3/KS/KS_stat_mean_' + str(z) + '.csv'
    #     std_KS_stat_list = []
    #     std_KS_stat_path = main_dir + '/labelme_3/KS/KS_stat_std_' + str(z) + '.csv'
    #
    #     mean_KS_pval_list = []
    #     mean_KS_pval_path = main_dir + '/labelme_3/KS/KS_pavl_mean_' + str(z) + '.csv'
    #     std_KS_pval_list = []
    #     std_KS_pval_path = main_dir + '/labelme_3/KS/KS_pavl_std_' + str(z) + '.csv'
    #
    ...
    #
    #             KL_list = []
    #             KL_path = main_dir + '/labelme_3/' + str(number) + '/' + generate_method_name + '/KL_total_' + str(
    #                 z) + '.csv'
    #
    #             KS_stat_list = []
    #             KS_stat_path = main_dir + '/labelme_3/' + str(
    #                 number) + '/' + generate_method_name + '/KS_stat_total_' + str(z) + '.csv'
    #             KS_pval_list = []
    #             KS_pval_path = main_dir + '/labelme_3/' + str(
    #                 number) + '/' + generate_method_name + '/KS_pval_total_' + str(z) + '.csv'
    #             for i in range(max_sampling_time):
    #
    #                 sample_path = main_dir + '/labelme_3/' + str(number) + '/sampling/sampling_' + str(i) + '.txt'
    #                 sample_data_list = pre_deal(sample_path, truth_file)
    #                 for j in range(max_generate_sum):
    #                     generate_file = main_dir + '/labelme_3/' + str(number) + '/' + generate_method_name + '/' + str(
    #                         i) + '_' + str(j) + '.txt'
    ...
    #     # 生成数据汇聚
    #     for generate_method_name in generate_methods:   # 生成方法 5
    #         acc_path = main_dir + '/labelme_3/' + str(number) + '/' + generate_method_name + '/accuracy.csv'
    ...
    #     # 样本数据汇聚
    #     for generate_method_name in generate_methods:  # 生成方法 5
    #         acc_path = main_dir + '/labelme_3/' + str(number) + '/sampling' + '/accuracy.csv'
    #         acc_applyResult_list = []
    #         for i in range(max_sampling_time):
    #             for converge_method_name in converge_methods:  # 汇聚方法 4
    #                 sample_file = main_dir + '/labelme_3/' + str(number) + '/sampling/sampling_' + str(i) + '.txt'
    ...
    for number in data_scale_range:   # 汇聚排序
        ...
        mean_total_path = main_dir + '/labelme_3/' + str(number) + '/mean.csv'
        mean_total_list = []

        std_total_path = main_dir + '/labelme_3/' + str(number) + '/std.csv'
        std_total_list = []

        sampling_acc_path = main_dir + '/labelme_3/' + str(number) + '/sampling' + '/accuracy.csv'
        ...
        for generate_method_name in generate_methods:  # 生成方法 5
            generate_acc_path = main_dir + '/labelme_3/' + str(number) + '/' + generate_method_name + '/accuracy.csv'
