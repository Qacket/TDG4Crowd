...
for i in range(8):
    mean = pd.read_csv('../../datasets/labelme_2/KL/KL_mean_' + str(i) + '.csv')
    std = pd.read_csv('../../datasets/labelme_2/KL/KL_std_' + str(i) + '.csv')


    path = '../../result/labelme_exp2/labelme_KL_exp2/exp2_label_' + str(i) + '.pdf'
