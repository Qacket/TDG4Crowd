...
from utils import pre_deal, all_list
...
crowd_file = '../../datasets/test_data/labelme_crowd_test.txt'
truth_file = '../../datasets/test_data/labelme_truth_test.txt'
...
for i in range(8):
    ...
    mean_sub = pd.read_csv('../../datasets/labelme_2/KS/KS_stat_mean_' + str(i) + '.csv')
    std_sub = pd.read_csv('../../datasets/labelme_2/KS/KS_stat_std_' + str(i) + '.csv')
    if i == 0:
...
path = '../../result/labelme_exp2/labelme_KS_exp2/exp2_KS.pdf'
...
plt.xlabel(u"Worker numbers")  # X轴标签
plt.ylabel("KS stats")  # Y轴标签
