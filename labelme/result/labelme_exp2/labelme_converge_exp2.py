...
for number in data_scale_range:
    ...
    mean = pd.read_csv('../../datasets/labelme_2/' + str(number) + '/mean.csv')
    std = pd.read_csv('../../datasets/labelme_2/' + str(number) + '/std.csv')
    path = '../../result/labelme_exp2/labelme_converge_exp2/exp2_converge_' + str(number) + '.pdf'
