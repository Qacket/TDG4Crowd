...
for i in range(8):
    ...
    mean_sub = pd.read_csv('../../datasets/labelme_2/KL/KL_mean_' + str(i) + '.csv')
    std_sub = pd.read_csv('../../datasets/labelme_2/KL/KL_std_' + str(i) + '.csv')
    if i == 0:
...
path = '../../result/labelme_exp2/labelme_KL_exp2/exp2_KL.pdf'
