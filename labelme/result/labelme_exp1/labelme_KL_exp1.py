...
for i in range(8):
    mean = pd.read_csv('../../datasets/labelme_1/KL/KL_mean_' + str(i) + '.csv')
    std = pd.read_csv('../../datasets/labelme_1/KL/KL_std_' + str(i) + '.csv')


    path = '../../result/labelme_exp1/labelme_KL_exp1/exp1_label_' + str(i) + '.pdf'
