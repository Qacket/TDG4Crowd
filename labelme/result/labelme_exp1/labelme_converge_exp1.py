...
for number in data_scale_range:
    ...
    mean = pd.read_csv('../../datasets/labelme_1/' + str(number) + '/mean.csv')
    std = pd.read_csv('../../datasets/labelme_1/' + str(number) + '/std.csv')
    path = '../../result/labelme_exp1/labelme_converge_exp1/exp1_converge_' + str(number) + '.pdf'
