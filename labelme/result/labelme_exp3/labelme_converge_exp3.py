...
for number in data_scale_range:
    ...
    mean = pd.read_csv('../../datasets/labelme_3/' + str(number) + '/mean.csv')
    std = pd.read_csv('../../datasets/labelme_3/' + str(number) + '/std.csv')
    path = '../../result/labelme_exp3/labelme_converge_exp3/exp3_converge_' + str(number) + '.pdf'
