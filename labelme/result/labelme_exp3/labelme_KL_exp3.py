...
for i in range(8):
    mean = pd.read_csv('../../datasets/labelme_3/KL/KL_mean_' + str(i) + '.csv')
    std = pd.read_csv('../../datasets/labelme_3/KL/KL_std_' + str(i) + '.csv')


    path = '../../result/labelme_exp3/labelme_KL_exp3/exp3_label_' + str(i) + '.pdf'
