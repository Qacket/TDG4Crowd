...
for number in data_scale_range:
    ...
    mean = pd.read_csv('../../datasets/labelme_4/' + str(number) + '/mean.csv')
    std = pd.read_csv('../../datasets/labelme_4/' + str(number) + '/std.csv')
    path = '../../result/labelme_exp4/labelme_converge_exp4/exp4_converge_' + str(number) + '.pdf'
