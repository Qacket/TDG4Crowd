...
for i in range(8):
    mean = pd.read_csv('../../datasets/labelme_4/KL/KL_mean_' + str(i) + '.csv')
    std = pd.read_csv('../../datasets/labelme_4/KL/KL_std_' + str(i) + '.csv')


    path = '../../result/labelme_exp4/labelme_KL_exp4/exp4_label_' + str(i) + '.pdf'
