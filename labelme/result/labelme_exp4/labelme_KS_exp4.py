...
for i in range(8):
    mean = pd.read_csv('../../datasets/labelme_4/KS/KS_stat_mean_' + str(i) + '.csv')
    std = pd.read_csv('../../datasets/labelme_4/KS/KS_stat_std_' + str(i) + '.csv')


    path = '../../result/labelme_exp4/labelme_KS_exp4/exp4_label_' + str(i) + '.pdf'
