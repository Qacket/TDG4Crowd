...
for i in range(8):
    ...
    mean_sub = pd.read_csv('../../datasets/labelme_4/KS/KS_stat_mean_' + str(i) + '.csv')
    std_sub = pd.read_csv('../../datasets/labelme_4/KS/KS_stat_std_' + str(i) + '.csv')
    if i == 0:
...
path = '../../result/labelme_exp4/labelme_KS_exp4/exp4_KS.pdf'
