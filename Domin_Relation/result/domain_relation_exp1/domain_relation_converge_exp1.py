...
for number in data_scale_range:
    ...
    mean = pd.read_csv('../../datasets/domain_relation_1/' + str(number) + '/mean.csv')
    std = pd.read_csv('../../datasets/domain_relation_1/' + str(number) + '/std.csv')
    path = '../../result/domain_relation_exp1/domain_relation_converge_exp1/exp1_converge_' + str(number) + '.pdf'
