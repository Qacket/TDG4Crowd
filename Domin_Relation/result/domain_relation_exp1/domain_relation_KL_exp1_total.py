...
for i in range(13):
    ...
    mean_sub = pd.read_csv('../../datasets/domain_relation_1/KL/KL_mean_' + str(i) + '.csv')
    std_sub = pd.read_csv('../../datasets/domain_relation_1/KL/KL_std_' + str(i) + '.csv')
    if i == 0:
...
path = '../../result/domain_relation_exp1/domain_relation_KL_exp1/exp1_KL.pdf'
