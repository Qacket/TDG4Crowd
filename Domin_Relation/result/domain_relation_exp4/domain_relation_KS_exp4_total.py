...
for i in range(13):
    ...
    mean_sub = pd.read_csv('../../datasets/domain_relation_4/KS/KS_stat_mean_' + str(i) + '.csv')
    std_sub = pd.read_csv('../../datasets/domain_relation_4/KS/KS_stat_std_' + str(i) + '.csv')
    if i == 0:
...
path = '../../result/domain_relation_exp4/domain_relation_KS_exp4/exp4_KS.pdf'
y0 = list(mean['0'])
y1 = list(mean['1'])
y2 = list(mean['2'])
y3 = list(mean['3'])
