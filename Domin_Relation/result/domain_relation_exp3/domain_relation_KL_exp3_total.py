...
for i in range(13):
    ...
    mean_sub = pd.read_csv('../../datasets/domain_relation_3/KL/KL_mean_' + str(i) + '.csv').fillna(0)
    std_sub = pd.read_csv('../../datasets/domain_relation_3/KL/KL_std_' + str(i) + '.csv').fillna(0)
...
path = '../../result/domain_relation_exp3/domain_relation_KL_exp3/exp3_KL.pdf'
