...
from generate.generate_data import generating_fixed_task, generating
from sample.sample_data import sampling

from relation import Relation
from utils import pre_deal, cal_acc, calculate_kl_ks
...
if __name__ == '__main__':
    ...
    # generate_methods = ['Mymodel_generate']
    converge_methods = ['DS', 'HDS', 'MV', 'GLAD']
    data_scale_range = range(100, 300, 100)
    max_sampling_time = 5
    max_generate_sum = 5
    pool = Pool()
    ...
    #         sample_file = main_dir + '/domain_relation_3/' + str(number) + '/sampling/sampling_' + str(i) + '.txt'
    ...
    #                 generate_file = main_dir + '/domain_relation_3/' + str(number) + '/' + generate_method_name + '/' + str(i) + '_' + str(j) + '.txt'
    #                 if generate_method_name == 'Mymodel_generate':
    #                     generating(crowd_file, truth_file, sample_file, generate_method_name, generate_file, test_loader)  # 生成20个数据集
    #                 else:
    #                     pool.apply_async(generating,
    #                                      args=(crowd_file, truth_file, sample_file, generate_method_name, generate_file, test_loader))
    #
    # pool.close()
    # pool.join()
    ...
    #     print(z, " --------------------------------------------------------------")
    #     mean_KL_list = []
    #     mean_KL_path = main_dir + '/domain_relation_3/KL/KL_mean_' + str(z) + '.csv'
    #     std_KL_list = []
    #     std_KL_path = main_dir + '/domain_relation_3/KL/KL_std_' + str(z) + '.csv'
    #
    #     mean_KS_stat_list = []
    #     mean_KS_stat_path = main_dir + '/domain_relation_3/KS/KS_stat_mean_' + str(z) + '.csv'
    #     std_KS_stat_list = []
    #     std_KS_stat_path = main_dir + '/domain_relation_3/KS/KS_stat_std_' + str(z) + '.csv'
    #
    #     mean_KS_pval_list = []
    #     mean_KS_pval_path = main_dir + '/domain_relation_3/KS/KS_pavl_mean_' + str(z) + '.csv'
    #     std_KS_pval_list = []
    #     std_KS_pval_path = main_dir + '/domain_relation_3/KS/KS_pavl_std_' + str(z) + '.csv'
    #
    ...
    #
    #             KL_list = []
    #             KL_path = main_dir + '/domain_relation_3/' + str(number) + '/' + generate_method_name + '/KL_total_' + str(
    #                 z) + '.csv'
    #
    #             KS_stat_list = []
    #             KS_stat_path = main_dir + '/domain_relation_3/' + str(
    #                 number) + '/' + generate_method_name + '/KS_stat_total_' + str(z) + '.csv'
    #             KS_pval_list = []
    #             KS_pval_path = main_dir + '/domain_relation_3/' + str(
    #                 number) + '/' + generate_method_name + '/KS_pval_total_' + str(z) + '.csv'
    #             for i in range(max_sampling_time):
    #
    #                 sample_path = main_dir + '/domain_relation_3/' + str(number) + '/sampling/sampling_' + str(i) + '.txt'
    #                 sample_data_list = pre_deal(sample_path, truth_file)
    #
    #                 if len(sample_data_list[z]) != 0:
    #
    #                     for j in range(max_generate_sum):
    #                         generate_file = main_dir + '/domain_relation_3/' + str(number) + '/' + generate_method_name + '/' + str(
    #                             i) + '_' + str(j) + '.txt'
    #                         generate_data_list = pre_deal(generate_file, truth_file)
    #
    #                         kl, ks_stat, ks_pval = calculate_kl_ks(sample_data_list[z], generate_data_list[z])
    #
    #                         KL_list.append(kl)
    ...
    #     # 生成数据汇聚
    #     for generate_method_name in generate_methods:   # 生成方法 5
    #         acc_path = main_dir + '/domain_relation_3/' + str(number) + '/' + generate_method_name + '/accuracy.csv'
    ...
    # for number in data_scale_range:
    #     # 原始采样数据汇聚
    #     # for generate_method_name in generate_methods:  # 生成方法 5    # 不用加这个
    #     acc_path = main_dir + '/domain_relation_3/' + str(number) + '/sampling' + '/accuracy.csv'
    #     acc_applyResult_list = []
    #     for i in range(max_sampling_time):
    #         for converge_method_name in converge_methods:  # 汇聚方法 4
    #             sample_file = main_dir + '/domain_relation_3/' + str(number) + '/sampling/sampling_' + str(i) + '.txt'
    ...
    #
    #     mean_total_path = main_dir + '/domain_relation_3/' + str(number) + '/mean.csv'
    #     mean_total_list = []
    #
    #     std_total_path = main_dir + '/domain_relation_3/' + str(number) + '/std.csv'
    #     std_total_list = []
    #
    #     sampling_acc_path = main_dir + '/domain_relation_3/' + str(number) + '/sampling' + '/accuracy.csv'
    ...
    #
    #     for generate_method_name in generate_methods:  # 生成方法 5
    #         generate_acc_path = main_dir + '/domain_relation_3/' + str(number) + '/' + generate_method_name + '/accuracy.csv'
