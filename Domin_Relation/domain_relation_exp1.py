...
if __name__ == '__main__':
    ...
    #                 generate_file = main_dir + '/domain_relation_1/' + str(number) + '/' + generate_method_name + '/' + str(i) + '_' + str(j) + '.txt'
    #                 if generate_method_name == 'Mymodel_generate':
    #                     generating_fixed_task(crowd_file, truth_file, exist_task, generate_method_name, generate_file, test_loader)  # 生成20个数据集
    #                 else:
    ...
    #                 for j in range(max_generate_sum):
    #
    #                     generate_file = main_dir + '/domain_relation_1/' + str(number) + '/' + generate_method_name + '/' + str(
    #                         i) + '_' + str(j) + '.txt'
    ...
    for z in range(13):
        ...
        mean_KL_list = []
        mean_KL_path = main_dir + '/domain_relation_1/KL/KL_mean_' + str(z) + '.csv'
        std_KL_list = []
        std_KL_path = main_dir + '/domain_relation_1/KL/KL_std_' + str(z) + '.csv'

        mean_KS_stat_list = []
        mean_KS_stat_path = main_dir + '/domain_relation_1/KS/KS_stat_mean_' + str(z) + '.csv'
        std_KS_stat_list = []
        std_KS_stat_path = main_dir + '/domain_relation_1/KS/KS_stat_std_' + str(z) + '.csv'

        mean_KS_pval_list = []
        mean_KS_pval_path = main_dir + '/domain_relation_1/KS/KS_pavl_mean_' + str(z) + '.csv'
        std_KS_pval_list = []
        std_KS_pval_path = main_dir + '/domain_relation_1/KS/KS_pavl_std_' + str(z) + '.csv'
        ...
        for number in data_scale_range:
            ...
            for generate_method_name in generate_methods:  # 生成方法 5
                ...
                KL_list = []
                KL_path = main_dir + '/domain_relation_1/' + str(number) + '/' + generate_method_name + '/KL_total_' + str(z) + '.csv'

                KS_stat_list = []
                KS_stat_path = main_dir + '/domain_relation_1/' + str(number) + '/' + generate_method_name + '/KS_stat_total_' + str(z) + '.csv'
                KS_pval_list = []
                KS_pval_path = main_dir + '/domain_relation_1/' + str(number) + '/' + generate_method_name + '/KS_pval_total_' + str(z) + '.csv'
                for i in range(max_sampling_time):
                    for j in range(max_generate_sum):
                        generate_file = main_dir + '/domain_relation_1/' + str(number) + '/' + generate_method_name + '/' + str(i) + '_' + str(j) + '.txt'
                        generate_data_list = pre_deal(generate_file, truth_file)
    ...
    #     # 生成数据汇聚
    #     for generate_method_name in generate_methods:   # 生成方法 5
    #         acc_path = main_dir + '/domain_relation_1/' + str(number) + '/' + generate_method_name + '/accuracy.csv'
    ...
    #
    #     mean_total_path = main_dir + '/domain_relation_1/' + str(number) + '/mean.csv'
    #     mean_total_list = []
    #
    #     std_total_path = main_dir + '/domain_relation_1/' + str(number) + '/std.csv'
    #     std_total_list = []
    #
    ...
    #
    #     for generate_method_name in generate_methods:  # 生成方法 5
    #         generate_acc_path = main_dir + '/domain_relation_1/' + str(number) + '/' + generate_method_name + '/accuracy.csv'
